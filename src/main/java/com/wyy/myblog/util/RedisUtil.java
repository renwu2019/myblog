...
/**
 * created by 伍猷煜 on 2022/7/4 17:20 星期一
...
public class RedisUtil {
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> hEntryGet(String key) {
     ...
     */
    public Boolean hEntrySet(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public Boolean hEntrySet(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
